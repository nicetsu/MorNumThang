...
export const CLASS_A_SYMPTOMS = [
  ...
  // อุบัติเหตุ/การบาดเจ็บที่อันตรายในตัวเอง — ไม่ใช่ "โรค" จึงไม่มีในกลุ่ม Class B แต่ต้องพบแพทย์เอง
  // (เดิมเข้า score ได้ทาง severity ของ LLM อย่างเดียว = เสี่ยง under-triage ถ้าโมเดลให้ต่ำ)
  "แผลไฟไหม้", "ไฟไหม้", "น้ำร้อนลวก", "โดนลวก",
  "สำลัก", "ติดคอ", "อาหารติดคอ",
  "เลือดออกไม่หยุด", "เลือดไหลไม่หยุด", "ตกเลือด",
];
...
const CRITICAL_SIGNS = ["หมดสติ", "ไม่รู้สึกตัว", "เรียกไม่รู้เรื่อง", "ชัก", "เกร็งกระตุก", "ไม่หายใจ", "หายใจไม่ออก", "ตัวเขียว", "ปากเขียว",
  // เลือดออกไม่หยุด/ตกเลือด = ภาวะเสียเลือดเฉียบพลัน → ด่วนมาก
  "เลือดออกไม่หยุด", "เลือดไหลไม่หยุด", "ตกเลือด"];
